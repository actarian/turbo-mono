...
export { isApiRequest, isExistingApiRoute, isNextRequest, isStaticRequest } from './middleware/middleware.service';
...
export { getStore, registerStorePages } from './store/store.service';
