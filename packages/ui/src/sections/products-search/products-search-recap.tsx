...
export default function ProductsSearchRecap({ filters, onChange }: { filters: Filter<ProductSearchItem>[], onChange: (filter: Filter<ProductSearchItem>, values: IEquatable[]) => void }) {
