...
export interface TextMedia1Item extends ILazyComponent {
  schema: 'text-media-1';
  title?: string;
  abstract?: string;
  description?: string;
...
export interface TextMedia1Props extends ILazyComponentProps {
  item: TextMedia1Item;
}

const TextMedia1: React.FC<TextMedia1Props> = ({ item }: TextMedia1Props) => {
